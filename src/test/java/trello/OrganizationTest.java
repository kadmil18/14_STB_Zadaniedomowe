...
public class OrganizationTest  {
    ...
    private static Stream<Arguments> createValidOrganizationData() {
        return Stream.of(
                Arguments.of("This is display name", "It's just an example", "correct", "https://test.pl"),
                Arguments.of("This is display name", "It's just an example", "correct", "http://test.pl"),
                Arguments.of("This is display name", "It's just an example", "okey", "http://test.pl"),
                Arguments.of("This is display name", "It's just an example", "correct_1", "http://test.pl"),
                Arguments.of("This is display name", "It's just an example", "correct1", "http://test.pl"));
    }

    private static Stream<Arguments> createInvalidOrganizationData() {
        return Stream.of(
                Arguments.of("", "It's just an example", "correct test", "https://stb.pl"),
                Arguments.of("This is display name", "", "correct123", "https://stb.pl"),
                Arguments.of("This is display name", "It's just an example", "o!", "https://stb.pl"),
                Arguments.of("This is display name", "It's just an example", "CORRECTtest@", "https://stb.pl"),
                Arguments.of("This is display name", "It's just an example", ".", "https://stb.pl"),
                Arguments.of("This is display name", "It's just an example", "correct", "www.stb.pl"));
    }
